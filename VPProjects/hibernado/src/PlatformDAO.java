...
public class PlatformDAO {
	public static Platform loadPlatformByORMID(int ID) throws PersistentException {
		try {
			PersistentSession session = AaaulaPersistentManager.instance().getSession();
	...
	public static boolean save(Platform platform) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().saveObject(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Platform platform) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().deleteObject(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Platform platform) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().getSession().refresh(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Platform platform) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().getSession().evict(platform);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
