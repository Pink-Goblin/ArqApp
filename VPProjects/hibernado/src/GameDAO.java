...
public class GameDAO {
	...
	public static boolean save(Game game) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().saveObject(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(Game game) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().deleteObject(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(Game game) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().getSession().refresh(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(Game game) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().getSession().evict(game);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
