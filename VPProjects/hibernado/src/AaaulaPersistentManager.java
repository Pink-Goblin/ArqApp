...
public class AaaulaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Aaaula";
	...
	private AaaulaPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new AaaulaPersistentManager();
		}
