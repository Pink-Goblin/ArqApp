...
public class UserDAO {
	...
	public static boolean save(User user) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().saveObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(User user) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().deleteObject(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(User user) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().getSession().refresh(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(User user) throws PersistentException {
		try {
			AaaulaPersistentManager.instance().getSession().evict(user);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
